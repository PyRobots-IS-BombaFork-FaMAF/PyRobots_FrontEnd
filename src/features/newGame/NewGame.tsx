      ...
      <Box component="form" onSubmit={onSubmit_newGame} >
        ...
        <Grid>
          <TextField required
            ...
            defaultValue="200" type="text" inputProps={{ maxLength: 3, pattern: games_amount_regex }}
          />
        </Grid>
        <Grid>
          <TextField required
            name="rounds-amount" label="Cantidad de rondas" variant="standard" helperText="Entre 1 y 10000"
            defaultValue="10000" type="text" inputProps={{ maxLength: 5, pattern: rounds_amount_regex }}
          />
        </Grid>
        <Grid>
          <TextField required
            name="max-players" label="Máximo de jugadores" variant="standard" helperText="Entre 2 y 4"
            defaultValue="4" type="text" inputProps={{ maxLength: 1, pattern: max_players_regex }}
          />
        </Grid>
        <Grid>
          <TextField required
            name="min-players" label="Mínimo de jugadores" variant="standard" helperText="Entre 2 y 4"
            defaultValue="2" type="text" inputProps={{ maxLength: 1, pattern: min_players_regex }}
          />
        </Grid>
        <Grid>
          <TextField
            name="password" label="Contraseña" variant="standard" helperText="Entre 8 y 16 caracteres"
            type="text" inputProps={{ maxLength: 16, pattern: password_regex }}
          />
        </Grid>
        <Button
          type="submit"
