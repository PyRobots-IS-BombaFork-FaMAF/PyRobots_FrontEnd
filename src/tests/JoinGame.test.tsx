...
describe(("Test a funcion joinGame"), () => {
    test(("Prueba si modifica el estado a joined"),() => {
            ...
            const expectedMatch : Match = {
                ...
                _current_players: 2,
                _creator: "test",
                _players: [{player : "test", robot: "robotTest"}, {player: "soyunuser", robot:"nuevoRobot"}],
                _creation_date: "",
                _password: "",
                _private: false,
                _gameStatus : 0,
            ...
            joinGame(data, robot, setActualMatch, setIsCreator, setMatches, userName, setShowLobby, setSocket, matches);
    ...
    test(("Prueba si modifica el estado a full"),() => {
        ...
        const match : Match = {
            ...
            _current_players: 2,
            _creator: "test",
            _players: [{player : "test", robot: "robotTest"}, {player: "hola", robot:"test1"}],
            _creation_date: "",
            _password: "",
            _private: false,
            _gameStatus : 0,
